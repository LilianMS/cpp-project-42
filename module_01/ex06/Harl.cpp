...
void Harl::complain(std::string level) {
	...
	switch (index) {
		case 0: goto debug_label;
		case 1: goto info_label;
		case 2: goto warning_label;
		case 3: goto error_label;
		default:
...
// void Harl::complain(std::string level) {
// 	// typedef void (Harl::*HarlMethod)(); // define tipo de ponteiro para método
